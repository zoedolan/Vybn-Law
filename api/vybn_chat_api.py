...
async def chat(request: Request):
    ...
    async def stream_response():
        ...
        try:
            ...
            msg = "I am currently offline — the inference engine on the Spark is not responding. Please try again later, or try again later."
            full_response = msg
